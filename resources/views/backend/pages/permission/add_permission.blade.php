...
<div class="page-content">
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page" style="padding-right: 10px; font-size: 20px; font-weight: 500">Add Permission</li>
    ...
    <div class="col-md-6">
        ...
        <select name="group_name" class="form-select mb-3" aria-label="Default select example">
            ...
            <option value="Resort Gallery ">Resort Gallery </option>
