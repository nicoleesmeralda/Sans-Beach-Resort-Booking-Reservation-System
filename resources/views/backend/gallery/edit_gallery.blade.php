                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item" style="font-size: 20px; font-weight: 500"><a href="{{ route('all.gallery') }}">Gallery</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page" style="padding-right: 10px; font-size: 20px; font-weight: 500">Edit Image</li>
