...
<div class="page-content">
        ...
        <div class="ps-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item" style="font-size: 20px; font-weight: 500"><a href="{{ route('booking.list') }}">Booking List</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page" style="padding-right: 10px; font-size: 20px; font-weight: 500">Booking Details</li>
              ...
              <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><b>Subtotal</b></td>
                            <td colspan="5" style="text-align: right;">₱{{ $editData->total_night * $editData->number_of_rooms * $editData->actual_price }}</td>
                        </tr>
                        <tr>
                            <td><b>Discount</b></td>
                            <td colspan="5" style="text-align: right;">₱{{ $editData->discount }}</td>
                        </tr>
                        <tr>
                            <td><b>Total</b></td>
                            <td colspan="5" style="text-align: right;">₱{{ $editData->total_night * $editData->number_of_rooms * $editData->actual_price - $editData->discount }}</td>
                        </tr>
                    </tbody> 
                </table>
    ...
    <div class="col-md-12 mb-2">
     <label for="" style="padding-left: 2px">Available Room(s): <span class="text-success availability"></span> </label> 
    </div>
...
<select name="status" id="input7" class="form-select">
    ...
    <ul class="list-group list-group-flush">
        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Name <span class="badge bg-primary rounded-pill" style="font-size: 12px">{{ $editData->name }}</span>
        </li>
        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Email <span class="badge bg-primary rounded-pill" style="font-size: 12px">{{ $editData->email }} </span>
        </li>
        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Phone <span class="badge bg-primary rounded-pill" style="font-size: 12px">{{ $editData->phone }}</span>
        </li>
        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Country <span class="badge bg-primary rounded-pill" style="font-size: 12px">{{ $editData->country }}</span>
        </li>

        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">City <span class="badge bg-primary rounded-pill" style="font-size: 12px">{{ $editData->city }}</span>
        </li>
        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Zip Code <span class="badge bg-primary rounded-pill" style="font-size: 12px"> {{ $editData->zip_code }} </span>
        </li>
        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Address <span class="badge bg-primary rounded-pill" style="font-size: 12px"> {{ $editData->address }} </span>
        </li>
