...
<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item active" aria-current="page" style="font-size: 20px; font-weight: 500">Add Booking</li>
							</ol>
						</nav>
					</div>
    ...
    <form method="POST" action="{{ route('store.roomlist') }}" class="row g-3">
     ...
     <input type="date" name="check_in" class="form-control" id="check_in"  >
        ...
        <div class="col-md-6">
            <label for="input3" class="form-label">Number of Rooms</label>
            ...
            <div class="mt-2">
                <label for="">Available Rooms: <span class="text-success availability" style="font-weight: 500"></span> </label>
            </div>
        ...
        <div class="col-md-6">
            <label for="input4" class="form-label">Number of Guests</label>
