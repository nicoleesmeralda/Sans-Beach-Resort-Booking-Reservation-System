...
<div class="banner-area" style="height: 480px;">
    <div class="container">
        <div class="banner-content">
            <h1>Your Getaway, Your Stay. Rent a Room, Relax in Paradise!</h1>
...
<div class="banner-form-area">
   ...
   <input autocomplete="off"  type="text" required name="check_out" class="form-control dt_picker" placeholder="yyyy-mm-dd">
                    ...
                    <div class="col-lg-2 col-md-2">
                        <div class="form-group">
                            <label style="font-weight: 700">GUESTS</label>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <button type="submit" class="default-btn btn-bg-one border-radius-5" style="font-weight: 700">
                            Check Availability 
                        </button>
                    </div>
                </div>
