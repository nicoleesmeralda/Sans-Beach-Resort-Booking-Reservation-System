...
class FrontendRoomController extends Controller
{
    ...
    public function BookingSeach(Request $request){
        ...
        if ($request->check_in == $request->check_out) {
            $notification = array(
                'message' => 'Same-day check-in and check-out is not permitted. Please adjust your booking dates.',
                'alert-type' => 'error'
            );
        ...
        if ($sdate > $edate) {
            $notification = array(
                'message' => 'Check-in date cannot be after the check-out date. Please adjust your booking dates.',
                'alert-type' => 'error'
            );
            return redirect()->back()->with($notification);
        }
