...
class RoomListController extends Controller
{
    ...
    public function StoreRoomList(Request $request){
           ...
           if ($request->check_in == $request->check_out) {
            $request->flash();
            $notification = array(
                'message' => 'You entered same dates',
                'alert-type' => 'error'
            );
           ...
           if ($request->available_room < $request->number_of_rooms) {
            $request->flash();
            $notification = array(
                'message' => 'You entered maximum number of rooms!',
                'alert-type' => 'error'
            );
           ...
           if ($room->total_adult +  $room->total_child < $request->number_of_person ) {
            $notification = array(
                'message' => 'You entered maximum number of guests!',
                'alert-type' => 'error'
            );
